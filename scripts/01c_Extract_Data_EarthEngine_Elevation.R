...
elev <- ee$Image('users/crollinson/MERIT-DEM-v1_250m_Reproj')#$select('elevation')
ee_print(elev)
...
extractElevEE(CitySP=citiesUse, CityNames = cityIDsAll, ELEV = elev, GoogleFolderSave = GoogleFolderSave, overwrite=overwrite)
