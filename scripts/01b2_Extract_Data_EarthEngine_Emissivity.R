...
# rgee::ee_Authenticate(user = 'crollinson@mortonarb.org', earthengine=T, drive=T, auth_mode="gcloud")
...
# var emissivityVis = {
#   min: 0.6, // Emissivity minimum
#   max: 1.0, // Emissivity maximum
#   palette: [ // A common color ramp
...
# };
# 
# // Assuming 'emissivityBand' is your selected image band
# Map.addLayer(emissivityBand, emissivityVis, 'Emissivity Visualization');
...
vizEmiss <- list(min=0.6, max=1.0, palette=emissColors)
